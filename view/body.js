        ...
        <div style="padding: 10px; box-sizing: border-box; width: 100%; max-width: 400px; margin: 10px auto;">
            ...
            ">
                <div style="display: flex; flex-direction: row; align-items: center; gap: 10px;">
                    <image src="https://raw.githubusercontent.com/DeePinnacle/CareerX_Propwise/main/public/img/Logo.png" alt="propwise-logo" style="width: 50px; height: 20px; display: block; margin: 0px auto;" />
